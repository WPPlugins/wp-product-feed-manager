<?php
/**
 * WPPFM Background Process
 *
 * Copied from https://deliciousbrains.com/background-processing-wordpress/
...
if ( ! class_exists( 'WPPFM_Background_Process' ) ) {
	...
	/**
	 * Abstract WPPFM_Background_Process class.
	 *
	 * @abstract
	...
	abstract class WPPFM_Background_Process extends WPPFM_Async_Request {
		...
		public function schedule_cron_healthcheck( $schedules ) {
			...
			$schedules[ $this->identifier . '_cron_interval' ] = array(
				...
				'display'  => sprintf( __( 'Every %d Minutes', 'wp-product-feed-manager' ), $interval ),
			);
